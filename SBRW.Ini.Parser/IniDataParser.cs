...
namespace SBRW.Ini.Parser
{
    ...
    public partial class IniDataParser
    {
        ...
        protected virtual bool ProcessComment(StringBuffer currentLine)
        {
            ...
            var range = SBRW.Ini.Parser.Parser.StringBuffer.Range.FromIndexWithSize(startIdx, size);
        ...
        protected virtual bool ProcessProperty(StringBuffer currentLine, IniData iniData)
        {
            ...
            var keyRange = SBRW.Ini.Parser.Parser.StringBuffer.Range.WithIndexes(0, propertyAssigmentIdx.start - 1);
            var valueStartIdx = propertyAssigmentIdx.end + 1;
            var valueSize = currentLine.Count - propertyAssigmentIdx.end - 1;
            var valueRange = SBRW.Ini.Parser.Parser.StringBuffer.Range.FromIndexWithSize(valueStartIdx, valueSize);
