...
namespace SBRW.Ini.Parser.Model
{
    ...
    public class SectionDataCollection : ICloneable, IEnumerable<SectionData>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SBRW.Ini.Parser.Model.SectionDataCollection"/> class.
        /// </summary>
        ...
        /// <param name="searchComparer"></param>
        ...
        /// 
        /// </summary>
        /// <param name="sectionsToMerge"></param>
